...
.to(line1, .8, {width: '109px', ease:Expo.easeOut}, '-=.8')
.to(line2, .8, {width: '239px', ease:Expo.easeOut}, '-=.7')
.to(line3, .8, {width: '259px', ease:Expo.easeOut}, '-=.6')
.to(natasha1, 1, {opacity: 1, y: -100, ease:Expo.easeOut}, 2)
